...
class StoreGetNewPassword extends StatefulWidget {
  const StoreGetNewPassword(
      {super.key, required this.email, required this.token});

  @override
  State<StoreGetNewPassword> createState() => _StoreGetNewPasswordState();
  final String email;
  final String token;
}
...
class _StoreGetNewPasswordState extends State<StoreGetNewPassword> {
  @override
  void dispose() {
                            ...
                            if (!Validators.minLengthCorrect(
                              ...
                              if (controllerPassword.text ==
                                ...
                                (isCompleted, response) =
                                    await ChangeStorePassword().changePassword(
                                        widget.token,
                                        controllerPassword.text,
                                        controllerConfirm.text);
                                if (isCompleted) {
